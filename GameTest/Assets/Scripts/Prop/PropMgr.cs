...
namespace Com.MyCompany.MyGame
{
    ...
    public class PropMgr : MonoBehaviour
    {
        ...
        {
            //初始化所有道具
            SpeedUpProp sp = new SpeedUpProp(1, (int)PROPGUID.SPEEDUP, "如燕散", "生死如渊，非燕雀而不得过","Images/Prop/juanzhou");
            ...
            RecoverProp rp = new RecoverProp(1, (int)PROPGUID.RECOVER, "生死簿拓本残页", "阴阳失衡，就连本供神佛传阅的拓本，也面目全非", "Images/Prop/juanzhou");
            NormalProp.Add(rp.EntityGUID, rp);
            RandomPosProp rpp = new RandomPosProp(1, (int)PROPGUID.RANDOMPOS, "忘川水", "原是界定生死之河，但如今已是随处可见，就连河水都清澈了不少", "Images/Prop/juanzhou");
            NormalProp.Add(rpp.EntityGUID, rpp);
            ShowSoulProp ssp = new ShowSoulProp(1, (int)PROPGUID.SHOWSOUL, "糯米", "南方民间辟邪之物，由门后判官给予，大概是种嘲弄吧", "Images/Prop/nuomi", 5,5);
